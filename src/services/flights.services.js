...
export const getFlights = async (req, res) => {
    try {
        ...
        console.log('Backend recibió solicitud para vuelos con filtros:', req.query);
...
export const getFlightById = async (req, res) => {
    ...
    try {
        ...
        return res.status(500).json({ message: "Error al obtener el vuelo por ID", error: error.message });
    }
};
